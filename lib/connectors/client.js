...
// console.log('afterOpened err = ' + err);
// console.log('afterOpened status = ' + status);
...
pageOpenedCallbackFired = false;
openPage();
        // throw new Error('Failed to connect client to server, status: ' + status);
      } else {
        pageOpened = true;
