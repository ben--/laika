...
function App(config) {
  ...
  this.close = function close(callback) {
    if(this.meteorApp) {
      var self = this;
      self.closeMeteor(function() {
        self.closeMongo(function() {
          self.emit('close');
          callback();
        });
      });
  ...
  this.closeMeteor = function(callback) {
    ...
    this.meteorApp.on('exit', callback);
    this.meteorApp.kill('SIGKILL');
  }

  this.closeMongo = function(callback) {
